        ...
        <aside class="w-64 bg-[#4A148C] text-white flex-shrink-0 hidden md:flex flex-col shadow-2xl z-20">
            ...
            <nav class="flex-1 px-3 py-6 space-y-1 overflow-y-auto custom-scrollbar">
                ...
                <template v-if="$page.props.auth.user.role === 'admin'">
                    ...
                    <Link :href="route('strategic-alignments.index')"
                          class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 font-medium group"
                          :class="route().current('strategic-alignments.*') ? 'bg-[#FDB913] text-[#4A148C] shadow-lg translate-x-1' : 'text-purple-100 hover:bg-purple-800/50 hover:text-white hover:translate-x-1'">
