        ...
        <aside class="w-64 bg-[#4A148C] text-white flex-shrink-0 hidden md:flex flex-col shadow-2xl z-20">
            ...
            <nav class="flex-1 px-3 py-6 space-y-1 overflow-y-auto custom-scrollbar">
                ...
                <Link :href="route('users.index')"
                    ...
                    <svg class="w-5 h-5 transition-transform group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
                    จัดการผู้ใช้ (Users)
                </Link>
            ...
            <div class="p-4 border-t border-purple-800/50 bg-[#380d6b] hover:bg-[#2d0a56] transition-colors cursor-pointer">
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-[10px] text-purple-300 truncate uppercase tracking-wide font-semibold">
                            {{ $page.props.auth.user.role || 'Staff' }}
                        </p>
                    </div>
                    <Link :href="route('logout')" method="post" as="button" class="text-purple-300 hover:text-[#FDB913] transition-colors p-2 hover:bg-white/10 rounded-full" title="ออกจากระบบ">
