...
// Sync ค่าจาก Parent (กรณีโหลดข้อมูลมาใส่ Form ครั้งแรก หรือตอนกดแก้ไข)
...
const onInput = (e) => {
    ...
    emit('update:id', null); // ⚠️ Clear ID ทิ้งทันทีที่เริ่มพิมพ์เปลี่ยนชื่อ (บังคับให้เลือกใหม่จาก List)
...
// ✅ ฟังก์ชันเคลียร์ค่าอย่างตั้งใจ (ปุ่ม X)
...
<template>
    <div class="relative w-full">
        <div class="relative flex items-center">
            <div class="absolute left-3 text-gray-400 z-10 flex items-center justify-center">
            ...
            <input
                ...
                class="w-full rounded-lg border-gray-300 focus:ring-[#7A2F8F] focus:border-[#7A2F8F] text-sm pl-10 pr-10"
                :class="{'bg-purple-50 text-purple-900 font-semibold border-purple-200': query && !showSuggestions}"
